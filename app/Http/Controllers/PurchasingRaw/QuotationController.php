...
class QuotationController extends Controller
{
    ...
    public function list(){
        ...
        return view('purchasing-raw-department.quotations.list')
        ...
        if ($request->ajax()){
            ...
            if($postMode=='action-quotation'){
                ...
                if($data['actionMode']=='view'){
                    ...
                    $banks = Bank::all();
                    return view('purchasing-raw-department.quotations.view')
                    ...
                    return view('purchasing-raw-department.quotations.update')
