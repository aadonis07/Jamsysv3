...
class LiquidationController extends Controller
{
    function showPrDetails(Request $request){
        ...
        if(isset($data['pr']) && !empty($data['pr'])){
            ...
            $selectQuery = PaymentRequest::with('details')
                ...
                ->first();
            return view('purchasing-supply-department.liquidation.page-load.pr-details')
    ...
    function showIndex(){
        $user = Auth::user();
        return view('purchasing-supply-department.liquidation.index')
            ...
            elseif($postMode == 'liquidation-list'){
                ...
                return Datatables::eloquent($selectQuery)
                    ->addColumn('actions', function($selectQuery) use ($user){
                        ...
                        if($user->department_id == $selectQuery->department_id){
