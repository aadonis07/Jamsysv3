...
var initApp = function(e) {
    return e.listFilter = function(t, e, o) {
        ...
        if (void 0 !== $.fn.dropdown ? Popper.Defaults.modifiers.computeStyle.gpuAcceleration = !1 : console.log("OOPS! bs.popover is not loaded"), $(document).on("click", ".dropdown-menu:not(.js-auto-close)", function(e) {
                e.stopPropagation()
                ...
                switch (!0) {
                    ...
                    case "panel-collapse" === o:
                        (l = $(this).closest(".panel")).children(".panel-container").collapse("toggle").on("show.bs.collapse", function() {
                    ...
                    case "panel-close" === o:
                        ...
                        "undefined" != typeof bootbox ? (initApp.playSound("media/sound", "messagebox"), bootbox.confirm({
                            title: "<i class='fal fa-times-circle text-danger mr-2'></i> Do you wish to delete panel <span class='fw-500'>&nbsp;'" + l.children(".panel-hdr").children("h2").text().trim() + "'&nbsp;</span>?",
