    ...
    function(t, e) {
        ...
        var p = function(n) {
            ...
            for (t in p = at.support = {}, s = at.isXML = function(t) {
                    ...
                    return i !== C && 9 === i.nodeType && i.documentElement && (a = (C = i).documentElement, E = !s(C), y !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), p.attributes = ut(function(t) {
                    ...
                    filter: {
                        ...
                        ATTR: function(n, i, o) {
                            return function(t) {
                                var e = at.attr(t, n);
                                return null == e ? "!=" === i : !i || (e += "", "=" === i ? e === o : "!=" === i ? e !== o : "^=" === i ? o && 0 === e.indexOf(o) : "*=" === i ? o && -1 < e.indexOf(o) : "$=" === i ? o && e.slice(-o.length) === o : "~=" === i ? -1 < (" " + e.replace(U, " ") + " ").indexOf(o) : "|=" === i && (e === o || e.slice(0, o.length + 1) === o + "-"))
                            }
                        },
            ...
            }, p.sortStable = T.split("").sort(N).join("") === T, p.detectDuplicates = !!c, x(), p.sortDetached = ut(function(t) {
        ...
        vt = E.createDocumentFragment().appendChild(E.createElement("div")), (bt = E.createElement("input")).setAttribute("type", "radio"), bt.setAttribute("checked", "checked"), bt.setAttribute("name", "t"), vt.appendChild(bt), b.checkClone = vt.cloneNode(!0).cloneNode(!0).lastChild.checked, vt.innerHTML = "<textarea>x</textarea>", b.noCloneChecked = !!vt.cloneNode(!0).lastChild.defaultValue;
        var wt = /^key/,
        ...
        T.event = {
            ...
            add: function(e, t, n, i, o) {
                ...
                if (m)
                    for (n.handler && (n = (r = n).handler, o = r.selector), o && T.find.matchesSelector(it, o), n.guid || (n.guid = T.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                            return void 0 !== T && T.event.triggered !== t.type ? T.event.dispatch.apply(e, arguments) : void 0
                        }), c = (t = (t || "").match(j) || [""]).length; c--;) p = g = (a = Ct.exec(t[c]) || [])[1], d = (a[2] || "").split(".").sort(), p && (h = T.event.special[p] || {}, p = (o ? h.delegateType : h.bindType) || p, h = T.event.special[p] || {}, u = T.extend({
                        type: p,
                        origType: g,
                        data: i,
                        handler: n,
                ...
                if (a.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, a)) {
                    for (s = T.event.handlers.call(this, a, c), e = 0;
                        ...
                        for (a.currentTarget = o.elem, n = 0;
                            (r = o.handlers[n++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !1 !== r.namespace && !a.rnamespace.test(r.namespace) || (a.handleObj = r, a.data = r.data, void 0 !== (i = ((T.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
        ...
        function Mt(n, i, o, r) {
            ...
            if (h && (e = (t = _t(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === t.childNodes.length && (t = e), e || r)) {
                ...
                if (a)
                    for (c = s[s.length - 1].ownerDocument, T.map(s, jt), u = 0; u < a; u++) l = s[u], pt.test(l.type || "") && !Q.access(l, "globalEval") && T.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, {
        ...
        function Qt() {
            if (Yt) {
                zt.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Yt.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", it.appendChild(zt).appendChild(Yt);
        ...
        zt = E.createElement("div"), (Yt = E.createElement("div")).style && (Yt.style.backgroundClip = "content-box", Yt.cloneNode(!0).style.backgroundClip = "", b.clearCloneStyle = "content-box" === Yt.style.backgroundClip, T.extend(b, {
        ...
        function ce(t, e, n) {
            ...
            return (!b.boxSizingReliable() && o || "auto" === s || !parseFloat(s) && "inline" === T.css(t, "display", !1, i)) && t.getClientRects().length && (o = "border-box" === T.css(t, "boxSizing", !1, i), (r = a in t) && (s = t[a])), (s = parseFloat(s) || 0) + le(t, e, n || (o ? "border" : "content"), r, i, s) + "px"
        }
        ...
        T.extend({
            ...
            T.cssHooks[l] = {
                get: function(t, e, n) {
                    if (e) return !ie.test(T.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? ce(t, l, n) : st(t, re, function() {
                        return ce(t, l, n)
                    })
                },
                set: function(t, e, n) {
        ...
        function we(r, t, e) {
            ...
            return T.map(u, _e, c), y(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), T.fx.timer(T.extend(l, {
                elem: r,
                anim: c,
                queue: c.opts.queue
            })), c
        ...
        }, pe = E.createElement("input"), de = E.createElement("select").appendChild(E.createElement("option")), pe.type = "checkbox", b.checkOn = "" !== pe.value, b.optSelected = de.selected, (pe = E.createElement("input")).value = "t", pe.type = "radio", b.radioValue = "t" === pe.value;
        ...
        T.extend(T.event, {
            trigger: function(t, e, n, i) {
                ...
                if (r = h = s = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !Ne.test(p + T.event.triggered) && (-1 < p.indexOf(".") && (p = (d = p.split(".")).shift(), d.sort()), l = p.indexOf(":") < 0 && "on" + p, (t = t[T.expando] ? t : new T.Event(p, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = d.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), e = null == e ? [t] : T.makeArray(e, [t]), u = T.event.special[p] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, e))) {
                    if (!i && !u.noBubble && !g(n)) {
        ...
        Qe.href = Ae.href, T.extend({
            ...
            ajax: function(t, e) {
                ...
                var u, h, f, n, p, i, d, g, o, r, m = T.ajaxSetup({}, e),
                    ...
                    x = {
                        ...
                        getResponseHeader: function(t) {
                            ...
                            if (d) {
                                if (!n)
                                    for (n = {}; e = Ue.exec(f);) n[e[1].toLowerCase() + " "] = (n[e[1].toLowerCase() + " "] || []).concat(e[2]);
                                e = n[t.toLowerCase() + " "]
                            }
                ...
                if (y.promise(x), m.url = ((t || m.url || Ae.href) + "").replace(Ye, Ae.protocol + "//"), m.type = e.method || e.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(j) || [""], null == m.crossDomain) {
                    i = E.createElement("a");
                    try {
        ...
        }), b.createHTMLDocument = ((en = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === en.childNodes.length), T.parseHTML = function(t, e, n) {
            return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (b.createHTMLDocument ? ((i = (e = E.implementation.createHTMLDocument("")).createElement("base")).href = E.location.href, e.head.appendChild(i)) : e = E), r = !n && [], (o = D.exec(t)) ? [e.createElement(o[1])] : (o = _t([t], e, r), r && r.length && T(r).remove(), T.merge([], o.childNodes)));
            var i, o, r
    ...
    function(t, e) {
        ...
        function p(t, e, n, i, o) {
            ...
            if ("viewport" === i) s = function(t, e) {
                ...
                var l = void 0;
                "scrollParent" === i ? "BODY" === (l = g(d(e))).nodeName && (l = t.ownerDocument.documentElement) : l = "window" === i ? t.ownerDocument.documentElement : i;
                var c = S(l, a, r);
        ...
        function Z(t, e) {
            ...
            ! function(t, e) {
                ...
                isCreated: !1,
                scrollParents: []
            }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(C({}, Z.Defaults.modifiers, i.modifiers)).forEach(function(t) {
            ...
            v = function() {
                ...
                return t.close = function(t) {
                    ...
                    var e = g.getSelectorFromElement(t),
                        n = !1;
                    return e && (n = document.querySelector(e)), n = n || d(t).closest("." + f)[0]
