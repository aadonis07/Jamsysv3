                                            ...
                                            <td>
                                                <div id="particular-{{ $enc_account_title_particular_id }}" style="display:none">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="particular_key" value="{{ $enc_account_title_id }}"/>
                                                        <input type="hidden" name="key" value="{{ $enc_account_title_particular_id }}"/>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="submit-accounting-title-form" action="{{ route('accounting-settings-functions',['id' => 'add-accounting-title-particular']) }}">
                    @csrf()
                        <div class="form-group">
                            <label>Particular Name :</label>
...
<div class="modal fade" id="update-accounting-title-particulars-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="update-accounting-title-form" action="{{ route('accounting-settings-functions',['id' => 'update-accounting-title-particular']) }}">
                    @csrf()
