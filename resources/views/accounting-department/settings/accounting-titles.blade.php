                                    ...
                                    <tr role="row " class="odd">
                                        ...
                                        <td style="vertical-align: middle" class="pb-0">
                                            <div class="demo text-center mb-0">
                                                ...
                                                <a href="{{ route('accounting-settings-accounting-title-particulars',['acctid'=>$enc_accounting_title_id]) }}" class="pb-0 btn btn-info btn-icon waves-effect waves-themed btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="PARTICULARS">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="submit-accounting-title-form" action="{{ route('accounting-settings-functions',['id' => 'add-accounting-titles']) }}" enctype="multipart/form-data">
                    @csrf()
...
<div class="modal fade" id="update-accounting-titles-modal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="update-accounting-title-form" action="{{ route('accounting-settings-functions',['id' => 'update-accounting-titles']) }}" enctype="multipart/form-data">
                    @csrf()
...
@section('scripts')
    ...
    <script>
        ...
        function updateAccountingTitle(id){
            var path = '{{ route("accounting-accounting-title-content") }}?id='+id;
        ...
        function logsModal(key){
            var url = "{{ route('accounting-settings-accounting-title-logs-details') }}";
            $('#logs-content').html('');
            $('#logs-content').html('' +
            ...
            $("#logs-content").load(url+"?atid="+key, function () {
                ...
                $('#dt-accounting-title-logs').DataTable({
                    ...
                    "serverSide": true,
                    "ajax":{
                        url :"{{ route('accounting-settings-functions',['id' => 'logs-accounting-titles-details']) }}", // json datasource
