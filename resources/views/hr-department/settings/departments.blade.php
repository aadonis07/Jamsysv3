                                ...
                                <tr role="row " class="odd">
                                    ...
                                    <td style="vertical-align: middle" class="pb-0">
                                        @php
                                            ...
                                            $positionUrl = route('hr-settings-positions',['did'=>$enc_department_id]);
                                        @endphp
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="update-department-form" action="{{ route('hr-settings-functions',['id' => 'update-departments']) }}" enctype="multipart/form-data">
                    @csrf()
...
@section('scripts')
    ...
    <script>
        ...
        function logsModal(key){
            var url = "{{ route('hr-settings-department-logs-details') }}";
            $('#logs-content').html('');
            $('#logs-content').html('' +
            ...
            $("#logs-content").load(url+"?did="+key, function () {
                ...
                $('#dt-department-logs').DataTable({
                    ...
                    "serverSide": true,
                    "ajax":{
                        url :"{{ route('hr-settings-functions',['id' => 'logs-departments-details']) }}", // json datasource
        ...
        function updateDepartment(id){
            var path = '{{ route("hr-department-content") }}?id='+id;
