...
<div class="row mb-3">
    ...
    <div class="col-md-4 text-right">
        <div class="row">
            <div class="col-md-7">
                <a href="{{ route('product-create-raw') }}" class="btn btn-primary btn-sm ">Add  <b>[ RAW / SPECIAL ]</b> </a>
            </div>
            <div class="col-md-5">
                <a href="{{ route('product-create-fit-out') }}" class="btn btn-primary btn-sm ">Add  <b>[ FIT OUT ]</b> </a>
            </div>
        </div>
