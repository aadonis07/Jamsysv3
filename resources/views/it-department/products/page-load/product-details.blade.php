...
<div class="col-md-12">
    <div class="tab-content">
        <div class="tab-pane fade show active" id="product-info" role="tabpanel">
            ...
            @endphp
            <form class="" role="form" id="update-product-form" onsubmit="$('#btn-update-product').attr('disabled',true)" method="POST" action="{{ route('product-functions',['id' => 'update-product']) }}" enctype="multipart/form-data">
                @csrf()
                <div class="row p-3">
                    <div class="col-md-8">
                        <div class="row">
