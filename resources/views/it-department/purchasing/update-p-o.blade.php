    ...
    <div class="row mb-3 ">
        <div class="col-lg-12 d-flex flex-start w-100">
            ...
            <div class="d-flex flex-fill">
                <div class="col-md-7">
                    <div class="flex-fill">
                        <span class="h5 mt-0">[ <text class="text-info">Purchase Order</text> ] {{ $supplier->inProgressPurchaseOrder->po_number }} </span>
        ...
        <div class="col-md-12">
            <div id="panel-1" class="panel">
                <div class="row p-3">
                        ...
                        <div class=" mb-3 alert alert-primary alert-dismissible">
                            <div class="row">
                                ...
                                <div class="col-md-3 text-right">
                                    <p class="mb-0  ">P.O #: <text class="text-primary fw-700"><b>{{ $supplier->inProgressPurchaseOrder->po_number }} &nbsp;&nbsp;</b></text></p>
                                    <p class="mb-0">Date Created: <text class="text-danger">{{ readableDate(getDatetimeNow()) }}</text></p>
                                    <p class="mb-0">Prepare By: </p>
                                    <p class="mb-0"><i class="text-primary">{{  $supplier->inProgressPurchaseOrder->createdBy->username }}</i></p>
                            ...
                            @foreach($cart as $product)
                                ...
                                <tr class="alert-info" title="queue-items"  id="row-{{ $product->id }}">
                                    ...
                                    <td>
                                        ...
                                        <hr class="m-0">
                                        <text class="text-primary">Date Created: <text id="date-added-{{ $product->id }}">[ SAVE ITEM FIRST ]</text></text>
                                        <hr class="m-0">
                    ...
                    <div class="col-md-3 text-right">
                        <form class="" role="form" id="move-to-pending-form" onsubmit="$('#save-po-btn').attr('disabled',true)" method="POST" action="{{ route('purchasing-functions',['id' => 'po-move-to-pending']) }}">
                            @csrf()
        ...
        function saveProduct(key,btn) {
            ...
            confirm_message('Save Item','Are you sure you want to save this item ?' , function (confirmed) {
                if(confirmed){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('purchasing-functions',['id' => 'add-product-to-po'])}}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        success: function (result) {
