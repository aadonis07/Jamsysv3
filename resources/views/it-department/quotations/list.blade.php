    ...
    <div class="col-lg-12 d-flex flex-start w-100 mb-2">
        ...
        <div class="row d-flex flex-fill">
            <div class="col-lg-7 flex-fill">
                ...
                <br>
                <p class="mb-0">In creating quotation, click <a href="{{ route('quotation-create')  }}" class="btn btn-primary btn-sm">Create Quotaion</a>.</p>
            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<form id="job-request-form" method="POST" action="{{ route('job-request-functions',['id' => 'create-job-request']) }}">
					@csrf()
...
<script>
 $(function(){
    $('#dt-quotation-pending').DataTable({
        ...
        "ajax":{
            url :"{{ route('quotation-functions',['id' => 'quotation-list-serverside']) }}",
            type: "POST",  
            data: {status:"PENDING"},
            "processing": true,
            "serverSide": true,
...
$(document).ready(function(index){
    $(document).on('click','.job_request',function(){
        var id = $(this).data('id');
        var path = "{{route('quotation-jobrequest')}}?id="+id;
