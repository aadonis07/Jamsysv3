    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="submit-accounting-paper-form" action="{{ route('settings-functions',['id' => 'add-accounting-papers']) }}" enctype="multipart/form-data">
                    @csrf()
...
<div class="modal fade" id="update-accounting-papers-modal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="update-accounting-paper-form" action="{{ route('settings-functions',['id' => 'update-accounting-papers']) }}" enctype="multipart/form-data">
                    @csrf()
...
@section('scripts')
    ...
    <script>
        ...
        function updateAccountingPaper(id){
            var path = '{{ route("accounting-paper-content") }}?id='+id;
        ...
        function logsModal(key){
            var url = "{{ route('settings-accounting-paper-logs-details') }}";
            $('#logs-content').html('');
            $('#logs-content').html('' +
            ...
            $("#logs-content").load(url+"?apid="+key, function () {
                ...
                $('#dt-accounting-paper-logs').DataTable({
                    ...
                    "serverSide": true,
                    "ajax":{
                        url :"{{ route('settings-functions',['id' => 'logs-accounting-papers-details']) }}", // json datasource
