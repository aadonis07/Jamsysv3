                                ...
                                <tr role="row " class="odd">
                                    ...
                                    <td style="vertical-align: middle" class="pb-0">
                                        ...
                                        <div class="demo text-center mb-0">
                                            <a href="javascript:void(0);" onClick="updateDepartment('{{ $enc_department_id }}')" class="pb-0 btn btn-info btn-icon waves-effect waves-themed" data-toggle="tooltip" data-placement="top" title="" data-original-title="UPDATE">
...
{{--====================================================================================--}}
<div class="modal fade" id="update-departments-modal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="update-department-form" action="{{ route('settings-functions',['id' => 'update-departments']) }}" enctype="multipart/form-data">
                    @csrf()
                      <div id="update-department-content">
                      </div>
                </form>
            </div>
            <div class="modal-footer pt-2">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="submit" form="update-department-form" class="btn btn-warning">Update</button>
            </div>
        </div>
    </div>
</div>
...
@section('scripts')
    ...
    <script>
        ...
        function updateDepartment(id){
            var path = '{{ route("department-content") }}?id='+id;
            $('#update-department-content').load(path);
            $('#update-departments-modal').modal('show');
        }
    </script>
@endsection
