...
<li class="breadcrumb-item ">
    <a class="text-info" href="{{ route('settings-departments') }}">Departments</a>
</li>
    ...
    <div class="col-lg-12">
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="" role="form" id="create-department"  method="POST"  action="{{route('settings-functions',['id' => 'add-position'])}}">
                            @csrf()
                            <div class="row">
                                <div class="col-lg-12">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-2">
                    <form method="post" id="update-position-form" action="{{ route('settings-functions',['id' => 'update-positions']) }}" enctype="multipart/form-data">
                        @csrf()
    ...
    <script>
           $('#dt-positions').dataTable({
            ...
            function logsModal(key){
                var url = "{{ route('settings-position-logs-details') }}";
                $('#logs-content').html('');
                $('#logs-content').html('' +
                ...
                $("#logs-content").load(url+"?pid="+key, function () {
                    ...
                    $('#dt-position-logs').DataTable({
                        ...
                        "serverSide": true,
                        "ajax":{
                            url :"{{ route('settings-functions',['id' => 'logs-position-details']) }}", // json datasource
            ...
            function updatePosition(id){
                var path = '{{ route("position-content") }}?id='+id;
