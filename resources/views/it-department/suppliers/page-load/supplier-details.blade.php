...
<div class="form-group row mb-2">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <input type="text" class="form-control bootstrap-tagsinput" name="supplier-contact-number-update" id="supplier-contact-number-update" value="{{ $supplier->contact_number }}">
    </div>
</div>
<div class="form-group row mb-2">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <select class="form-control" id="select-barangay-update" required name="select-barangay-update">
            ...
            @foreach($barangays as $barangay)
                ...
                $current_barangay = '';
                if($barangay->id == $supplier->barangay_id) {
