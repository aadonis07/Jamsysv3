                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <ul id="js-nav-menu" class="nav-menu mt-0">
                        <li  class="{{ isSelected('DASHBOARD',$active_menu,'active open') }}">
                            <a href="{{ route('accounting-dashboard') }}" title="Dashboard" data-filter-tags="Dashboard">
                        ...
                        <li class="{{ isSelected('ACCOUNTING',$active_menu,'active open') }}">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('accounting-payment-request-list') }}?type=cash" title="Cash Payment Request List" data-filter-tags="cash payment request list">
                                        {!! isSelected('CASH-LIST',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                        <span class="nav-link-text">Cash</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('accounting-payment-request-list') }}?type=cheques" title="Cheques Payment Request List" data-filter-tags="cheques payment request list">
                                        {!! isSelected('CHEQUE-LIST',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                        <span class="nav-link-text">Cheques</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('accounting-payment-request-create') }}" title="Create Payment Request" data-filter-tags="create payment request">
                        ...
                        <li class="{{ isSelected('LIQUIDATION',$active_menu,'active open') }}">
                            <a href="#" title="Payment Request" data-filter-tags="purchasing">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('accounting-liquidation-list') }}" title="Payment Request List" data-filter-tags="payment request list">
                        ...
                        <li class="{{ isSelected('SALES-INVOICE',$active_menu,'active open') }}">
                            <a href="{{route('accounting-sales-invoice')}}" title="Sales Invoice" data-filter-tags="Sales Invoice">
                                <i class="far fa-clipboard-list"></i>
                                <span class="nav-link-text" >Sales Invoice</span>
                            </a>
                        </li>
                        <li class="{{ isSelected('COLLECTION',$active_menu,'active open') }}">
                            <a href="javascript:;" title="Collection" data-filter-tags="Collection">
                                <i class="far fa-database"></i>
                                <span class="nav-link-text">Collection</span>
                            </a>
                            <ul>
                                <li>
                                    <a href="{{route('accounting-collection-list')}}" title="Collection Schedule List" data-filter-tags="Collection Schedule List">
                                        {!! isSelected('COLLECTION-LIST',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                        <span class="nav-link-text">Collection List</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="{{ isSelected('QUOTATION',$active_menu,'active open') }}">
                            <a href="{{route('accounting-quotation-list')}}" title="Quotation" data-filter-tags="quotation">
                                <i class="ni ni-basket"></i>
                                <span class="nav-link-text" data-i18n="nav.plugins">Quotations</span>
                            </a>
                        </li>	
                        ...
                        <li class="{{ isSelected('SETTINGS',$active_menu,'active open') }}">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('accounting-settings-accounting-papers') }}" title="Accounting Papers" data-filter-tags="Accounting Papers">
                                ...
                                <li>
                                    <a href="{{ route('accounting-settings-accounting-titles') }}" title="Accounting Titles" data-filter-tags="Accounting Titles">
                                ...
                                <li>
                                    <a href="{{ route('accounting-settings-banks') }}" title="Banks" data-filter-tags="Banks">
                                        {!! isSelected('BANKS',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                        <span class="nav-link-text">Banks</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('accounting-settings-payees') }}" title="Payees" data-filter-tags="Payees">
                                        {!! isSelected('PAYEES',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                        <span class="nav-link-text">Payees</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('accounting-settings-profile') }}" title="User Profile" data-filter-tags="User Profile">
                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="ml-auto d-flex">
                        ...
                        <div class="hidden-md-down">
                            <a href="{{route('accounting-settings-profile')}}" class="header-icon" >
                        ...
                        <div>
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                ...
                                <a href="{{ route('accounting-settings-profile') }}" class="dropdown-item" >
