                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-card-text">
                            ...
                            <span title="{{ $selectQuery->position->name  }}" class="d-inline-block text-truncate text-truncate-sm" style="  font-size: 12px!important; color: #d9d9d9;">
                    ...
                    <ul id="js-nav-menu" class="nav-menu mt-0">
                        ...
                        <li class="{{ isSelected('EMPLOYEE',$active_menu,'active open') }}">
                            ...
                            <ul>
                                <li>
                                    <a href="{{route('hr-employee-add')}}" title="Add Employee" data-filter-tags="employee add-employee">
                                ...
                                <li>
                                    <a href="{{route('hr-employee-view')}}" title="View Employee" data-filter-tags="employee view-employee">
                        ...
                        <li class="{{ isSelected('SETTINGS',$active_menu,'active open') }}">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('hr-settings-departments') }}" title="Departments" data-filter-tags="Departments">
