                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <ul id="js-nav-menu" class="nav-menu mt-0">
                        <li  class="{{ isSelected('DASHBOARD',$active_menu,'active open') }}">
                            <a href="{{ route('logistics-dashboard') }}" title="Dashboard" data-filter-tags="Dashboard">
                                <i class="fal fa-info-circle"></i>
                                <span class="nav-link-text">Dashboard</span>
                            </a>
                        </li>
                        <li  class="{{ isSelected('DELIVERY-SCHEDULE',$active_menu,'active open') }}">
                            <a href="{{ route('logistics-delivery-scehdule-list') }}" title="Delivery Schedule" data-filter-tags="Delivery Schedule">
                                <i class="fa fa-truck"></i>
                                <span class="nav-link-text">Delivery Schedule</span>
                            </a>
                        </li>
                        ...
                        <li class="{{ isSelected('SETTINGS',$active_menu,'active open') }}">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('logistics-settings-profile') }}" title="User Profile" data-filter-tags="User Profile">
            ...
            <div class="page-content-wrapper">
                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="ml-auto d-flex">
                        ...
                        <div class="hidden-md-down">
                            <a href="{{route('logistics-settings-profile')}}" class="header-icon" >
                        ...
                        <div>
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                ...
                                <a href="{{ route('logistics-settings-profile') }}" class="dropdown-item" >
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <ol class="breadcrumb page-breadcrumb">
                        <li class="breadcrumb-item"><a href="{{  route('logistics-dashboard')  }}">Dashboard</a></li>
                        @yield('breadcrumbs')
