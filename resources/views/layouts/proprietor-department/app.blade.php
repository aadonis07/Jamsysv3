                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <ul id="js-nav-menu" class="nav-menu mt-0">
                        <li  class="{{ isSelected('DASHBOARD',$active_menu,'active open') }}">
                            <a href="{{ route('proprietor-dashboard') }}" title="Dashboard" data-filter-tags="Dashboard">
                        ...
                        <li class="{{ isSelected('QUOTATION',$active_menu,'active open') }}">
                            <a href="{{route('proprietor-quotation-list')}}" title="Quotation" data-filter-tags="quotation">
                        ...
                        <li class="{{ isSelected('PURCHASING',$active_menu,'active open') }}">
                            ...
                            <ul>
                                <li>
                                    <a href="{{route('proprietor-purchasing-list')}}" title="View Employee" data-filter-tags="employee view-employee">
                        ...
                        <li class="{{ isSelected('ACCOUNTING',$active_menu,'active open') }}">
                            <a href="#" title="Payment Request" data-filter-tags="payment request">
                                <i class="fas fa-money-bill-alt"></i>
                                <span class="nav-link-text">Payment Request </span>
                            </a>
                            <ul>
                                <li>
                                    <a href="{{route('proprietor-payment-request-list')}}" title="View Employee" data-filter-tags="payment request list">
                                        {!! isSelected('LIST',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                        <span class="nav-link-text">List</span>
                                    </a>
                                </li>
                        ...
                        <li class="{{ isSelected('SETTINGS',$active_menu,'active open') }}">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('proprietor-settings-profile') }}" title="User Profile" data-filter-tags="User Profile">
            ...
            <div class="page-content-wrapper">
                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="ml-auto d-flex">
                        ...
                        <div class="hidden-md-down">
                            <a href="{{route('proprietor-settings-profile')}}" class="header-icon" >
                        ...
                        <div>
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                ...
                                <a href="{{ route('proprietor-settings-profile') }}" class="dropdown-item" >
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <ol class="breadcrumb page-breadcrumb">
                        <li class="breadcrumb-item"><a href="{{  route('proprietor-dashboard')  }}">Dashboard</a></li>
                        @yield('breadcrumbs')
