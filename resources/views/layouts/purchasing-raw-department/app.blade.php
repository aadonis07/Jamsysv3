            ...
            <nav id="js-primary-nav" class="primary-nav" role="navigation">
                ...
                <ul id="js-nav-menu" class="nav-menu mt-0">
                    <li  class="{{ isSelected('DASHBOARD',$active_menu,'active open') }}">
                        <a href="{{ route('purchasing-raw-dashboard') }}" title="Dashboard" data-filter-tags="Dashboard">
                    ...
                    <li class="{{ isSelected('PRODUCTS',$active_menu,'active open') }}">
                        ...
                        <ul>
                            <li>
                                <a href="{{ route('purchasing-raw-product-list') }}" title="All Products" data-filter-tags="All Products" >
                                    {!! isSelected('LIST',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                    <span class="nav-link-text">All Products</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('purchasing-raw-product-create') }}" title="Create Product">
                    ...
                    <li class="{{ isSelected('SUPPLIERS',$active_menu,'active open') }}">
                        <a href="{{ route('purchasing-raw-suppliers') }}" title="Suppliers" data-filter-tags="Suppliers">
                    ...
                    <li class="{{ isSelected('PURCHASING',$active_menu,'active open') }}">
                        ...
                        <ul>
                            <li>
                                <a href="{{route('purchasing-raw-list')}}" title="View Purchasing" data-filter-tags="purchasing po-list">
                                    {!! isSelected('LIST',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                    <span class="nav-link-text">List</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('purchasing-raw-supplier-list')}}" title="Add Employee" data-filter-tags="employee add-employee">
                    ...
                    <li class="{{ isSelected('QUOTATIONS',$active_menu,'active open') }}">
                        <a href="{{ route('purchasing-raw-quotation-list') }}" title="Quotations">
                    ...
                    <li class="{{ isSelected('ACCOUNTING',$active_menu,'active open') }}">
                        ...
                        <ul>
                            <li>
                                <a href="{{ route('purchasing-raw-payment-request-list') }}" title="Payment Request List" data-filter-tags="payment request list">
                                    {!! isSelected('LIST',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                    <span class="nav-link-text">List</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('purchasing-raw-payment-request-create') }}" title="Create Payment Request" data-filter-tags="create payment request">
                    ...
                    <li class="{{ isSelected('LIQUIDATION',$active_menu,'active open') }}">
                        ...
                        <ul>
                            <li>
                                <a href="{{ route('purchasing-raw-liquidation-list') }}" title="Payment Request List" data-filter-tags="payment request list">
                                    {!! isSelected('LIST',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                    <span class="nav-link-text">List</span>
                                </a>
                            </li>
                    ...
                    <li class="{{ isSelected('SETTINGS',$active_menu,'active open') }}">
                        ...
                        <ul>
                            <li class="{{ isSelected('USER-PROFILE',$active_menu,'active open') }}">
                                <a href="{{ route('purchasing-raw-settings-profile') }}" title="User Profile">
        ...
        <div class="page-content-wrapper">
            ...
            <header class="page-header" role="banner">
                ...
                <div class="ml-auto d-flex">
                    ...
                    <div class="hidden-md-down">
                        <a href="{{ route('purchasing-raw-settings-profile') }}" class="header-icon" >
                    ...
                    <div>
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                            ...
                            <a href="{{ route('purchasing-raw-settings-profile') }}" class="dropdown-item" >
            ...
            <main id="js-page-content" role="main" class="page-content">
                <ol class="breadcrumb page-breadcrumb">
                    <li class="breadcrumb-item"><a href="{{  route('purchasing-raw-dashboard')  }}">Dashboard</a></li>
                    @yield('breadcrumbs')
