                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <ul id="js-nav-menu" class="nav-menu mt-0">
                        <li  class="{{ isSelected('DASHBOARD',$active_menu,'active open') }}">
                            <a href="{{ route('sales-dashboard') }}" title="Dashboard" data-filter-tags="Dashboard">
                                <i class="fal fa-info-circle"></i>
                                <span class="nav-link-text">Dashboard</span>
                            </a>
                        </li>
                        <li class="{{ isSelected('CLIENTS',$active_menu,'active open') }}">
                            <a href="{{ route('sales-clients') }}" title="Clients" data-filter-tags="Clients">
                        ...
                        <li class="{{ isSelected('PRODUCTS',$active_menu,'active open') }}">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('sales-product-list') }}" title="All Products" data-filter-tags="All Products" >
                                        {!! isSelected('LIST',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                        <span class="nav-link-text">All Products</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('sales-product-create') }}" title="Create Product">
                        ...
                        <li class="{{ isSelected('QUOTATION',$active_menu,'active open') }}">
                            <a href="#" title="Quotation" data-filter-tags="quotation">
                                <i class="ni ni-basket"></i>
                                <span class="nav-link-text" data-i18n="nav.plugins">Quotations</span>
                            </a>
                            <ul>
                                <li>
                                    <a href="{{route('sales-quotation-create')}}" title="Create Quotation" data-filter-tags="quotation create-quotation">
                                        {!! isSelected('CREATE-QUOTATION',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                        <span class="nav-link-text" data-i18n="nav.plugins_plugins_faq">Create Quotation</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('sales-quotation-list')}}" title="Quotation List" data-filter-tags="quotation list-quotation">
                                        {!! isSelected('LIST-QUOTATION',$active_sub_menu,'<i class="ni ni-chevron-right"></i>') !!}
                                        <span class="nav-link-text" data-i18n="nav.plugins_plugins_faq">Quotation List</span>
                                    </a>
                                </li>
                            </ul>
                        </li>	
                        <li class="{{ isSelected('JOB-REQUEST',$active_menu,'active open') }}">
                            <a href="{{ route('sales-job-request-list') }}" title="Job Request">
                                <i class="fa fa-archive"></i>
                                <span class="nav-link-text" >Job Request</span>
                            </a>
                        </li>
                        ...
                        <li class="{{ isSelected('SETTINGS',$active_menu,'active open') }}">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ route('sales-settings-profile') }}" title="User Profile" data-filter-tags="User Profile">
                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="ml-auto d-flex">
                        ...
                        <div class="hidden-md-down">
                            <a href="{{route('sales-settings-profile')}}" class="header-icon" >
                        ...
                        <div>
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                ...
                                <a href="{{ route('sales-settings-profile') }}" class="dropdown-item" >
