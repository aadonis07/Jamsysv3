@extends ('layouts.logistics-warehouse-supply-department.app')
@section ('title')
    User Profile
@endsection
@section ('styles')
                ...
                <div class="panel-content">
                        <div class="row">
                            ...
                            <div class="col-lg-6" style="padding:10px;">
                                <form method="post" id="update-password-form" action="{{ route('logistics-warehouse-supply-settings-functions', ['id' => 'change-password']) }}">
                                @csrf()
