                ...
                <div class="row p-3">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs " role="tablist">
                            <li class="nav-item "><a class="nav-link fs-sm text-info active" data-toggle="tab" href="#for-approval-tab" role="tab">FOR-APPROVAL</a></li>
...
@section('scripts')
    ...
    <script>
        $('#for-approval-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('proprietor-payment-request-functions',['id' => 'for-approval-payment-request-list'])}}", // json datasource
        ...
        $('#approved-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('proprietor-payment-request-functions',['id' => 'approved-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#released-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('proprietor-payment-request-functions',['id' => 'released-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#rejected-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('proprietor-payment-request-functions',['id' => 'rejected-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#cancelled-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('proprietor-payment-request-functions',['id' => 'cancelled-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        function showPartial(key){
            ...
            $('#partial-payment-table').DataTable({
                ...
                "ajax":{
                    url :"{{ route('proprietor-payment-request-functions',['id' => 'partial-payment-list']) }}", // json datasource
                    type: "POST",  // method  , by default get
