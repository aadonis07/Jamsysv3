            ...
            <div class="d-flex flex-fill">
                ...
                <div class="col-md-5 ">
                    <div class="form-group" align="right">
                        <a href="{{ route('purchasing-raw-payment-request-create') }}" class="btn btn-info"><span class="fa fa-plus"></span> Create P.R</a>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        $('#r-department-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-raw-payment-request-functions',['id' => 'r-department-payment-request-list'])}}", // json datasource
        ...
        $('#pending-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-raw-payment-request-functions',['id' => 'pending-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#for-approval-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-raw-payment-request-functions',['id' => 'for-approval-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#approved-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-raw-payment-request-functions',['id' => 'approved-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#released-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-raw-payment-request-functions',['id' => 'released-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#rejected-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-raw-payment-request-functions',['id' => 'rejected-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#cancelled-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-raw-payment-request-functions',['id' => 'cancelled-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        function showPartial(key){
            ...
            $('#partial-payment-table').DataTable({
                ...
                "ajax":{
                    url :"{{ route('purchasing-raw-payment-request-functions',['id' => 'partial-payment-list']) }}", // json datasource
                    type: "POST",  // method  , by default get
