...
@endsection
@section('breadcrumbs')
    <li class="breadcrumb-item"><a href="{{ route('purchasing-raw-product-list') }}">Products</a></li>
    <li class="breadcrumb-item">Add Product [ RAW / SPECIAL ] ITEM</li>
@endsection
@section('content')
@php
...
@endphp
<form class="" role="form" id="create-product-raw" onsubmit="$('#btn-add-raw').attr('disabled',true)" method="POST" action="{{ route('purchasing-raw-product-functions',['id' => 'add-product-raw']) }}" enctype="multipart/form-data">
    @csrf()
    <div class="row mb-3">
        <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" onChange=""  name="sub_category" id="sub-category" >
