            ...
            <div id="panel-1" class="panel">
                <div class="row p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 text-right">
                                    ...
                                    @if($purchaseOrder->status == 'APPROVED')
                                        ...
                                        <div class="alert alert-warning mt-1 p-2 text-left">
                                            <p class="text-danger m-0"> *Note: Based on supplier's info
                                            <p><b>
                                                    <text title="Payment type">P. TYPE:</text>
                    ...
                    @if($purchaseOrder->status == 'PENDING')
                        ...
                        <div class="col-md-3 text-right">
                            <form class="" role="form" id="move-to-for-approval-form" onsubmit="$('#save-po-btn').attr('disabled',true)" method="POST" action="{{ route('purchasing-raw-purchasing-functions',['id' => 'po-move-to-for-approval']) }}">
                                @csrf()
                    ...
                    @elseif($purchaseOrder->status == 'FOR-APPROVAL')
                        ...
                        <div class="col-md-2 ">
                            <a target="_blank" href="{{ route('purchasing-raw-pdf-p-o-details',['po' => $purchaseOrder->po_number]) }}" class="btn btn-warning btn-block btn-sm"><span class="fas fa-print"></span> | PRINT [ Internal ]</a>
                        </div>
                    @elseif($purchaseOrder->status == 'APPROVED')
                        ...
                        <div class="col-md-2 ">
                            <a target="_blank" href="{{ route('purchasing-raw-pdf-p-o-details',['po' => $purchaseOrder->po_number]) }}" class="btn btn-warning btn-block btn-sm"><span class="fas fa-print"></span> | PRINT P.O</a>
                        </div>
                    @elseif($purchaseOrder->status == 'REJECTED')
                        ...
                        <div class="col-md-4 text-right">
                            <form  id="update-po-status-form" action="{{ route('purchasing-raw-purchasing-functions',['id' => 'po-update-status']) }}" method="POST">
                                @csrf()
                                <div class="row mt-0">
        ...
        <div class="modal fade" id="update-payment-status-modal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body pt-0">
                        <form method="post" id="update-payment-type-form" onSubmit="$('#update-payment-status-btn').attr('disabled',true)" action="{{ route('purchasing-raw-purchasing-functions',['id' => 'update-po-payment-type']) }}">
                            @csrf()
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
