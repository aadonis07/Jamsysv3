        ...
        <div class="col-md-12">
            <div id="panel-1" class="panel">
                <div class="row p-3">
                                ...
                                <td colspan="2" class="p-1 align-middle">
                                    ...
                                    <div class="form-group">
                                        @php
                                            ...
                                            $ewt_amount = ewtComputation($total_purchased,0,$supplier->vatable,0);
                    ...
                    <div class="col-md-3 text-right">
                        <form class="" role="form" id="move-to-pending-form" onsubmit="$('#save-po-btn').attr('disabled',true)" method="POST" action="{{ route('purchasing-raw-purchasing-functions',['id' => 'po-move-to-pending']) }}">
                            @csrf()
...
@section('scripts')
    ...
    <script>
                        ...
                        success: function (result) {
                            if(result.success == 0){
                                ...
                                if(result.is_reload == true){
                                    window.location.replace("{{ route('supplier-create-p-o',['sid'=> $enc_supplier_id]) }}");
                                }
                            }
        ...
        function saveProduct(key,btn) {
            ...
            confirm_message('Save Item','Are you sure you want to save this item ?' , function (confirmed) {
                if(confirmed){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('purchasing-raw-purchasing-functions',['id' => 'add-product-to-po'])}}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        success: function (result) {
        ...
        function ewtFormulation(total_purchased,discount,is_vat,ewt,btn){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('purchasing-raw-purchasing-functions',['id' => 'compute-ewt'])}}",
                data: formData,
                contentType: false,
                processData: false,
                success: function (result) {
