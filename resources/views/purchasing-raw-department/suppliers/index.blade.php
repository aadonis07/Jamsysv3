    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="submit-supplier-form" action="{{ route('purchasing-raw-supplier-functions',['id' => 'add-suppliers']) }}" enctype="multipart/form-data">
                    @csrf()
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <input type="text" class="bootstrap-tagsinput" required name="supplier-contact-number" id="supplier-contact-number" >
                            </div>
                        </div>
                        <div class="form-group row mb-2">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
<div class="modal fade" id="update-suppliers-modal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="update-supplier-form" action="{{ route('purchasing-raw-supplier-functions',['id' => 'update-suppliers']) }}" enctype="multipart/form-data">
                    @csrf()
    ...
    <script>
        ...
        $(function(){
            ...
            supplerTable = $('#suppliers-tbl').DataTable({
                ...
                "ajax":{
                    url :"{{ route('purchasing-raw-supplier-functions',['id' => 'supplier-list']) }}", // json datasource
            ...
            $('#select-region').on('change', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("purchasing-raw-supplier-functions", ["id" => "fetch-provinces"]) }}',
                    data: formData,
                    CrossDomain:true,
                    contentType: !1,
                    processData: !1,
            ...
            $('#select-province').on('change', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("purchasing-raw-supplier-functions", ["id" => "fetch-cities"]) }}',
                    data: formData,
                    CrossDomain:true,
                    contentType: !1,
                    processData: !1,
        ...
        function updateSupplier(id){
            var path = '{{ route("purchasing-raw-supplier-content") }}?id='+id;
        ...
        function logsModal(key){
            var url = "{{ route('purchasing-raw-supplier-logs-details') }}";
            $('#logs-content').html('');
            $('#logs-content').html('' +
            ...
            $("#logs-content").load(url+"?sid="+key, function () {
                ...
                $('#dt-supplier-logs').DataTable({
                    ...
                    "serverSide": true,
                    "ajax":{
                        url :"{{ route('purchasing-raw-supplier-functions',['id' => 'logs-suppliers-details']) }}", // json datasource
                        type: "POST",  // method  , by default get
                        data : data,
                        error: function(result){  // error handling
                            $('#err').html(JSON.stringify(result));
