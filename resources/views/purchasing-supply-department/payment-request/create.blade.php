...
@section('scripts')
    ...
    <script>
        ...
        function createRequest(){
            ...
            confirm_message('Create Payment Request','Are you sure you want to  create this request ?' , function (confirmed) {
                if(confirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('purchasing-supply-payment-request-functions',['id' => 'create-payment-request'])}}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        success: function (result) {
        ...
        function addPoInvoice(btn){
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('purchasing-supply-payment-request-functions',['id' => 'add-invoice-details']) }}",
                data: formData,
                contentType: false,
                processData: false,
                success: function (result){
