                ...
                <div class="row p-3">
                    @if($payment_request->status == 'RELEASED' && $payment_request->type == 'CHEQUE' && $payment_request->is_partial == false)
                        <div class="col-md-12 text-right">
                            <a target="_blank" href="{{ route('purchasing-supply-payment-request-pdf-print-cheque',['prid'=> $enc_payment_request_id]) }}" disabled class="btn btn-warning btn-sm"><span class="fas fa-print"></span> | PRINT CHEQUE</a>
                            <hr class="mt-2 mb-2">
                        </div>
                    @endif
                    <div class="col-md-7">
                    ...
                    @if($payment_request->status == 'REJECTED')
                        ...
                        <div class="col-md-6 text-right">
                            <form method="post"  id="revert-payment-status-form" onsubmit="$('#update-payment-status-btn').attr('disabled',true)" id="update-payment-request-status" action="{{ route('purchasing-supply-payment-request-functions',['id' => 'update-payment-request-status']) }}">
                                @csrf()
