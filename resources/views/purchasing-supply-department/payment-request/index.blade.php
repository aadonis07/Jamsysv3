    ...
    <div class="row mb-3 ">
        <div class="col-lg-12 d-flex flex-start w-100">
            ...
            <div class="d-flex flex-fill">
                <div class="col-md-7">
                    <div class="flex-fill">
                        <span class="h5 mt-0">Payment Request</span>
                        <p class="mb-0">List of Payment Request. Please update all information listed below.</p>
                    </div>
                </div>
                <div class="col-md-5 ">
                    <div class="form-group" align="right">
                        <a href="{{ route('purchasing-supply-payment-request-create') }}" class="btn btn-info"><span class="fa fa-plus"></span> Create P.R</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row p-3">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs " role="tablist">
                            <li class="nav-item "><a class="nav-link active fs-sm text-warning" data-toggle="tab" href="#r-department-tab" role="tab">REQUEST BY DEPARTMENT</a></li>
                    ...
                    <div class="col-md-12 p-3">
                        <div class="tab-content">
                            <div class="tab-pane show active" id="r-department-tab" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-12 p-2">
                                        <table id="r-department-tbl" class="table table-bordered table-hover w-100 dataTable dtr-inline">
                            ...
                            <div class="tab-pane show" id="pending-tab" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-12 p-2">
...
@section('scripts')
    ...
    <script>
        $('#r-department-tbl').DataTable({
            "pageLength": 25,
            "processing": true,
            "serverSide": true,
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-supply-payment-request-functions',['id' => 'r-department-payment-request-list'])}}", // json datasource
        ...
        $('#pending-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-supply-payment-request-functions',['id' => 'pending-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#for-approval-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-supply-payment-request-functions',['id' => 'for-approval-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#approved-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-supply-payment-request-functions',['id' => 'approved-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#released-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-supply-payment-request-functions',['id' => 'released-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#rejected-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-supply-payment-request-functions',['id' => 'rejected-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        $('#cancelled-tbl').DataTable({
            ...
            "responsive": true,
            "ajax":{
                url :"{{route('purchasing-supply-payment-request-functions',['id' => 'cancelled-payment-request-list'])}}", // json datasource
                type: "POST",  // method  , by default get
                error: function(data){  // error handling
                    $('#err').html(JSON.stringify(data));
                }
        ...
        function showPartial(key){
            ...
            $('#partial-payment-table').DataTable({
                ...
                "ajax":{
                    url :"{{ route('purchasing-supply-payment-request-functions',['id' => 'partial-payment-list']) }}", // json datasource
                    type: "POST",  // method  , by default get
