            ...
            <div id="panel-1" class="panel">
                <div class="row p-3">
                    @if($payment_request->status == 'R-DEPARTMENT')
                        ...
                        <div class="col-md-5 text-right">
                            <form method="post"  id="update-payment-status-form" onsubmit="$('#update-payment-status-btn').attr('disabled',true)" id="update-payment-request-status" action="{{ route('purchasing-supply-payment-request-functions',['id' => 'update-payment-request-status']) }}">
                                @csrf()
                    ...
                    <div class="col-md-6 mt-2">
                        ...
                        <div class="row pr-suppliers-details" style="display:none">
                            ...
                            <div class="col-md-12 check-details-section mb-2" style="display:none">
                                <div class="row" >
                                    <div class="col-md-12">
                                        <div class="row mb-2">
                                            <div class="col-md-7">
                    ...
                    @if($payment_request->status == 'PENDING')
                        <div class="col-md-6 text-danger">
                            <p>* Note: Payment status is ON <b>PENDING</b>. Please wait to validate by the accounting.   </p>
                        </div>
                    ...
                    @elseif($payment_request->status == 'R-DEPARTMENT')
                        <div class="col-md-6 text-danger">
                            <p>* Note: Payment status is ON <b>R-DEPARTMENT</b>. Modification in this request is enabled.   </p>
                        </div>
                        <div class="col-md-6 text-right">
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0 mt-0">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post"  id="cancel-payment-status-form" onsubmit="$('#cancel-pr-btn').attr('disabled',true)" id="update-payment-request-status" action="{{ route('purchasing-supply-payment-request-functions',['id' => 'update-payment-request-status']) }}">
                                @csrf()
                                <div class="form-group">
    ...
    <script>
        ...
        function employees(){
            ...
            $('#employees-table').DataTable({
                ...
                "ajax":{
                    url :"{{ route('purchasing-supply-payment-request-functions',['id' => 'employee-list']) }}", // json datasource
        ...
        function payees(){
            $("#payee").select2({
                ajax:{
                    type: "POST",
                    url: "{{ route('purchasing-supply-payment-request-functions',['id' => 'payee-list']) }}",
                    //dataType: 'json',
                    delay: 250,
        ...
        function addParticipant(btn){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('purchasing-supply-payment-request-functions',['id' => 'add-particulars'])}}",
                data: formData,
                contentType: false,
                processData: false,
        ...
        function suppliers(){
            ...
            $('#suppliers-table').DataTable({
                ...
                "lengthMenu": [[50, 100, 150, 250], [50, 100, 150, 250]],
                "ajax":{
                    url :"{{ route('purchasing-supply-payment-request-functions',['id' => 'supplier-list']) }}", // json datasource
                    type: "POST",  // method  , by default get
                    error: function(result){  // error handling
                        $('#err').html(JSON.stringify(result));
                    }
        ...
        function clients(){
            ...
            $('#clients-table').DataTable({
                ...
                "lengthMenu": [[50, 100, 150, 250], [50, 100, 150, 250]],
                "ajax":{
                    url :"{{ route('purchasing-supply-payment-request-functions',['id' => 'clients-list']) }}", // json datasource
                    type: "POST",  // method  , by default get
                    error: function(result){  // error handling
                        $('#err').html(JSON.stringify(result));
                    }
        ...
        function getParticulars(key){
            ...
            $.ajax({
                type: "POST",
                url: "{{route('purchasing-supply-payment-request-functions',['id' => 'get-particulars'])}}",
                data: formData,
                contentType: false,
                processData: false,
                success: function (result) {
        ...
        function addPrSupplier(key){
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('purchasing-supply-payment-request-functions',['id' => 'supplier-validated-po']) }}", // STATUS: APPROVED P. STATUS: FOR-REQUEST
                data: formData,
                contentType: false,
                processData: false,
                success: function (result) {
        ...
        function selectClientQuotation(key,tempKey){
            ...
            $('#client-quotations-table').DataTable({
                ...
                "lengthMenu": [[50, 100, 150, 250], [50, 100, 150, 250]],
                "ajax":{
                    url :"{{ route('purchasing-supply-payment-request-functions',['id' => 'client-quotations-list']) }}", // json datasource
                    type: "POST",  // method  , by default get
                    data : { client: key },
                    error: function(result){  // error handling
                        $('#err').html(JSON.stringify(result));
        ...
        function updateRequest(){
            ...
            confirm_message('Update Payment Request','Are you sure you want to  update this request ?' , function (confirmed) {
                if(confirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('purchasing-supply-payment-request-functions',['id' => 'update-payment-request'])}}",
                        data: formData,
                        contentType: false,
                        processData: false,
                        success: function (result) {
        ...
        function createPartial(btn){
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('purchasing-supply-payment-request-functions',['id' => 'create-partial-payment-request']) }}",
                data: formData,
                contentType: false,
                processData: false,
                success: function (result){
