            ...
            <div class="d-flex flex-fill">
                ...
                <div class="col-md-5 ">
                    <div class="form-group" align="right">
                        <a href="{{ route('purchasing-supply-supplier-list') }}" class="btn btn-primary"><span class="fa fa-plus"></span> Create P.O</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(function(){
            $('#in-progress-tbl').DataTable({
                ...
                "serverSide": true,
                "ajax":{
                    url :"{{route('purchasing-supply-purchasing-functions',['id' => 'in-progress-po-list'])}}", // json datasource
            ...
            $('#pending-tbl').DataTable({
                ...
                "serverSide": true,
                "ajax":{
                    url :"{{route('purchasing-supply-purchasing-functions',['id' => 'pending-po-list'])}}", // json datasource
                    type: "POST",  // method  , by default get
                    error: function(data){  // error handling
                        $('#err').html(JSON.stringify(data));
                    }
            ...
            $('#for-approval-tbl').DataTable({
                ...
                "serverSide": true,
                "ajax":{
                    url :"{{route('purchasing-supply-purchasing-functions',['id' => 'for-approval-po-list'])}}", // json datasource
                    type: "POST",  // method  , by default get
                    error: function(data){  // error handling
                        $('#err').html(JSON.stringify(data));
                    }
            ...
            $('#approved-tbl').DataTable({
                ...
                "serverSide": true,
                "ajax":{
                    url :"{{route('purchasing-supply-purchasing-functions',['id' => 'approved-po-list'])}}", // json datasource
                    type: "POST",  // method  , by default get
                    error: function(data){  // error handling
                        $('#err').html(JSON.stringify(data));
                    }
            ...
            $('#completed-tbl').DataTable({
                ...
                "serverSide": true,
                "ajax":{
                    url :"{{route('purchasing-supply-purchasing-functions',['id' => 'completed-po-list'])}}", // json datasource
                    type: "POST",  // method  , by default get
                    error: function(data){  // error handling
                        $('#err').html(JSON.stringify(data));
                    }
            ...
            $('#cancelled-tbl').DataTable({
                ...
                "serverSide": true,
                "ajax":{
                    url :"{{route('purchasing-supply-purchasing-functions',['id' => 'cancelled-po-list'])}}", // json datasource
                    type: "POST",  // method  , by default get
                    error: function(data){  // error handling
                        $('#err').html(JSON.stringify(data));
                    }
