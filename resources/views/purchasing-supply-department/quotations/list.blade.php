...
<!-- ============================================================================ -->
<form id="action-form" method="POST" action="{{ route('purchasing-supply-quotation-functions',['id' => 'action-quotation']) }}">
    @csrf()
...
<script>
 $(function(){
	...
	$('#dt-quotation-moved').DataTable({
        ...
        "ajax":{
            url :"{{ route('purchasing-supply-quotation-functions',['id' => 'quotation-list-serverside']) }}",
            type: "POST",  
