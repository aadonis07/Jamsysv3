...
@endsection
@section('breadcrumbs')
<li class="breadcrumb-item"><a href="{{ route('sales-clients') }}">Clients</a></li>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="submit-company-branch-form" action="{{ route('sales-client-functions',['id' => 'add-company-branches']) }}" enctype="multipart/form-data">
                    @csrf()
...
<div class="modal fade" id="update-company-branches-modal" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-2">
                <form method="post" id="update-company-branch-form" action="{{ route('sales-client-functions',['id' => 'update-company-branches']) }}" enctype="multipart/form-data">
                    @csrf()
...
@section('scripts')
    ...
    <script>
        ...
        function updateCompanyBranch(id){
            var path = '{{ route("sales-client-branch-content") }}?id='+id;
        ...
        function logsModal(key){
            var url = "{{ route('sales-client-branch-logs-details') }}";
            $('#logs-content').html('');
            $('#logs-content').html('' +
            ...
            $("#logs-content").load(url+"?cbid="+key, function () {
                ...
                $('#dt-company-branch-logs').DataTable({
                    ...
                    "serverSide": true,
                    "ajax":{
                        url :"{{ route('sales-client-functions',['id' => 'logs-company-branches-details']) }}", // json datasource
