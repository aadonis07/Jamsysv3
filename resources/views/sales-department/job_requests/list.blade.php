...
$(function(){
    $('#dt-jr-pending').DataTable({
        ...
        "ajax":{
            url :"{{ route('sales-job-request-functions',['id' => 'jr-pending-serverside']) }}",
            type: "POST",  
            data: {status:"PENDING"},
            "processing": true,
            "serverSide": true,
    ...
    $('#dt-jr-ongoing').DataTable({
		...
		"lengthMenu": [[50, 100, 150, 250], [50, 100, 150, 250]],
        "ajax":{
            url :"{{ route('sales-job-request-functions',['id' => 'jr-ongoing-serverside']) }}",
            type: "POST",  
            data: {status:"ONGOING"},
            "processing": true,
            "serverSide": true,
    ...
    $('#dt-jr-accomplished').DataTable({
		...
		"lengthMenu": [[50, 100, 150, 250], [50, 100, 150, 250]],
        "ajax":{
            url :"{{ route('sales-job-request-functions',['id' => 'jr-accomplished-serverside']) }}",
            type: "POST",  
    ...
    $('#dt-jr-request-reject').DataTable({
		...
		"lengthMenu": [[50, 100, 150, 250], [50, 100, 150, 250]],
        "ajax":{
            url :"{{ route('sales-job-request-functions',['id' => 'jr-request-reject-serverside']) }}",
            type: "POST",  
    ...
    $('#dt-jr-rejected').DataTable({
		...
		"lengthMenu": [[50, 100, 150, 250], [50, 100, 150, 250]],
        "ajax":{
            url :"{{ route('sales-job-request-functions',['id' => 'jr-rejected-serverside']) }}",
            type: "POST",  
    ...
    $('#dt-jr-cancelled').DataTable({
		...
		"lengthMenu": [[50, 100, 150, 250], [50, 100, 150, 250]],
        "ajax":{
            url :"{{ route('sales-job-request-functions',['id' => 'jr-cancelled-serverside']) }}",
            type: "POST",  
    ...
    $('#dt-jr-declined').DataTable({
		...
		"lengthMenu": [[50, 100, 150, 250], [50, 100, 150, 250]],
        "ajax":{
            url :"{{ route('sales-job-request-functions',['id' => 'jr-declined-serverside']) }}",
            type: "POST",  
