                ...
                <div class="col-lg-12">
                    ...
                    <Br>
                        <div class="form-group">
                            ...
                            <input class="form-control" disabled value="CUSTOMIZED" style="font-family:Arial Black;text-align:center;"/>
                        </div>
                    </div>
                        ...
                        <div class="frame-wrap mb-0">
                            <table class="table table-bordered table-hover mb-0" id="variants-tbl">
                                <thead class="thead-themed">
                                    <tr>
                                        <th class="small text-center" width="60%">VARIANTS</th>
                                        <th class="small text-center" width="30%">BASE PRICE</th>
...
<script>
    ...
    function genCombination(){
        ...
        if (attributes_tbody.children().length == 0) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('sales-product-functions',['id' => 'generate-combination'])}}",
                data: formData,
                contentType: false,
                processData: false,
    ...
    function createProduct(){
        ...
        $('input[name^="base_price"]').each(function() {
            formData.append('base_price[]',$(this).val());
        });
        ...
        $.ajax({
            type: "POST",
            url: "{{route('sales-product-functions',['id' => 'create-product-with-variants'])}}",
            data: formData,
            contentType: false,
            processData: false,
            success: function (result) {
