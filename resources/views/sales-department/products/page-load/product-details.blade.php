<div class="col-md-12">
    <ul class="nav nav-tabs" role="tablist">
        ...
        @if($product->type != 'RAW' && $product->type != 'SPECIAL-ITEM' && $product->type != 'FIT-OUT')
...
<div class="col-md-12">
    <div class="tab-content">
        <div class="tab-pane fade show active" id="product-info" role="tabpanel">
            ...
            @endphp
            <form class="" role="form" id="update-product-form" onsubmit="$('#btn-update-product').attr('disabled',true)" method="POST" action="{{ route('sales-product-functions',['id' => 'update-product']) }}" enctype="multipart/form-data">
                @csrf()
                <div class="row p-3">
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" required onChange="genSwatches(null,this.value)"  name="sub_category" id="sub-category" >
                            ...
                            @if($product->type == 'FIT-OUT' )
                                <div class="col-md-12 mt-2">
                                    ...
                                    <table id="fitout-tbl" class="table table-bordered w-100">
                                        <thead>
                                        <tr>
                                            <th width="5%"></th>
                                        ...
                                        @foreach($product->variants as $index=>$variant)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <hr class="m-0">
                                                    <strong>
                                                        <text class="text-primary small">TYPE: {{ $variant->type }}</text>
                                                    </strong>
                                                </td>
                                                <td>
                ...
                <div class="row p-3">
                    <div class="col-md-12">
                        ...
                        <table id="variant-tbl" class="table table-bordered w-100">
                            ...
                            <tr>
                                <th width="5%"></th>
                                <th width="65%">Attributes & Values</th>
