...
@endsection
@section('breadcrumbs')
    <li class="breadcrumb-item"><a href="{{ route('sales-product-list') }}">Products</a></li>
                                                    ...
                                                    <div class="accordion accordion-clean accordion-hover" id="add-product-supply-section">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div id="supply-product-section" class="collapse" data-parent="#add-product-supply-section">
                                                                <div class="card-body">
                                                                    <form method="post" id="add-product-supply-form" action="{{ route('sales-product-functions',['id' => 'add-to-fitout-product']) }}" >
                                                                        @csrf()
                                                                        <div class="row">
                                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="accordion accordion-clean accordion-hover" id="add-product-raw-section">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div id="raw-product-section" class="collapse" data-parent="#add-product-raw-section">
                                                                <div class="card-body">
                                                                    <form method="post" id="add-product-raw-form" action="{{ route('sales-product-functions',['id' => 'add-to-fitout-product']) }}" >
                                                                        @csrf()
                                                                        <div class="row">
                                                                            <div class="col-md-9">
                                                                                <div class="form-group mb-1">
                            ...
                            <tbody>
                                @foreach($product->variants as $index=>$variant)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form class="" role="form" id="update-variant-{{ $enc_variant_id }}-price-form" onsubmit="$('#{{ $enc_variant_id }}-price-btn').attr('disabled',true)" method="POST" action="{{ route('sales-product-functions',['id' => 'update-variant-price']) }}">
                                                @csrf()
                                                ...
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="number" class="form-control" readonly required step=".01" name="base_price" value="{{ $variant->base_price }}" placeholder="Base Price">
                                ...
                                @foreach($product->variants as $index=>$variant)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form class="" role="form" id="update-variant-{{ $enc_variant_id }}-price-form" onsubmit="$('#{{ $enc_variant_id }}-price-btn').attr('disabled',true)" method="POST" action="{{ route('sales-product-functions',['id' => 'update-variant-price']) }}">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="number" class="form-control" required step=".01" readonly name="base_price" value="{{ $variant->base_price }}" placeholder="Base Price">
                                                    <div class="input-group-append">
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <form class="" role="form" id="{{ $enc_product_id }}-set-variant-default-form" onsubmit="$('#{{ $enc_variant_id }}-btn').attr('disabled',true)" method="POST" action="{{ route('sales-product-functions',['id' => 'variant-default']) }}">
                                                    @csrf()
                                                    <input type="hidden" value="{{ $enc_product_id }}" name="product"/>
                                                    <input type="hidden" value="{{ $enc_variant_id }}" name="variant"/>
                                                </form>
