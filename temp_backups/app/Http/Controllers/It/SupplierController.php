                ...
                $selectQuery = SupplierProduct::with('updatedBy')
                    ...
                    return Datatables::eloquent($selectQuery)
                                    ->addColumn('actions', function($selectQuery){
                                        ...
                                        $returnValue .= '<button onClick=logsModal("'.$enc_supplier_product_id.'") class="btn btn-default btn-sm btn-icon waves-effect waves-themed mb-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="HISTORY LOGS">
                ...
                $selectQuery = Supplier::orderBy('created_at');
                    return Datatables::eloquent($selectQuery)
                            ->addColumn('actions', function($selectQuery){
                                ...
                                $returnValue .= '<a href="'.$productsUrl.'" class="btn btn-info btn-icon btn-sm waves-effect waves-themed mb-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="VIEW PRODUCTS">
                                                    <i class="fas fa-tag"></i>
                                                </a>&nbsp;';
                                $returnValue .= '<button onClick=logsModal("'.$enc_supplier_id.'") class="btn btn-default btn-sm btn-icon waves-effect waves-themed mb-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="HISTORY LOGS">
                                            <i class="ni ni-calendar"></i>
                                        </button>';
                                return $returnValue;
                            })
