...
<div class="row">
	...
	<div class="col-md-12">
        ...
        <div class="tab-pane fade show {{$personal_tab}}" id="personal-information" role="tabpanel" aria-labelledby="Personal Info Div">
            <div class="col-lg-12">
                <div id="panel-4" class="panel">
                    <form method="post" id="personal-information-form"  action="{{ route('hr-employee-functions', ['id' => 'personal-information']) }}">
                        @csrf()
        ...
        <div class="tab-pane fade show {{$background_tab}}" id="background" role="tabpanel" aria-labelledby="Background Div">
            <div id="panel-4" class="panel">
                <form method="post" id="background-information-form"  action="{{ route('hr-employee-functions', ['id' => 'background-information']) }}">
                        @csrf()
                <div class="row p-5">
        ...
        <div class="tab-pane fade show {{$employee_tab}}" id="employee-information" role="tabpanel" aria-labelledby="Emplyoee Info Div">
            <div id="panel-4" class="panel">
                <form method="post" id="employee-information-form"  action="{{ route('hr-employee-functions', ['id' => 'employee-information']) }}">
                @csrf()
                <div class="row p-5">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding-top:22px;">
                                <div class="form-group">
                                    <label>Access Code : </label>
                                    <input type="number" class="form-control" value="{{$access_code}}" name="access_code" placeholder="Access Code" maxlength="5"/>
                                </div>
                                <div class="form-group">
                ...
                <div class="row p-5">
                        <div class="col-lg-12  text-center">
                            ...
                            <button type="submit" class="btn btn-warning waves-effect waves-themed" form="employee-information-form">Next <i class="fas fa-arrow-right"></i></button>
                        </div>
                </div>
                </form>
            </div>
        ...
        <div class="tab-pane fade show {{$picture_tab}}" id="picture-information" role="tabpanel" aria-labelledby="Picture Div">
            <div id="panel-4" class="panel">
                <form method="post" id="picture-information-form"  action="{{ route('hr-employee-functions', ['id' => 'save-information']) }}" enctype="multipart/form-data">
                @csrf()
                    <div class="row p-5">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
   ...
   $(document).ready(function(index){
       if('{{$mode_alert}}'=='yes'){
        ...
        $(document).on('change','select[name="position_id"]',function(){
            var id = $(this).val();
            $.post("{{ route('hr-employee-functions', ['id' => 'get-department']) }}",
            {
                id: id,
            },
            function(data){
                console.log(data);
               $('select[name="department_id"]').val(data).change();
            });
        });
