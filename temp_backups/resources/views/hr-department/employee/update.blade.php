	...
	<div class="col-md-12">
        ...
        <div class="tab-pane fade show" id="employee-information" role="tabpanel" aria-labelledby="Emplyoee Info Div">
            <div id="panel-4" class="panel">
                ...
                <div class="row p-5">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding-top:22px;">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="{{$employee->access_code}}" name="access_code" placeholder="Access Code" maxlength="5"/>
                                </div>
                                <div class="form-group">
                ...
                <div class="row p-5">
                    <div class="col-lg-12  text-center">
                        <button type="submit" class="btn btn-warning waves-effect waves-themed"> <i class="ni ni-note"></i> Update Employee Information </button>
                    </div>
                </div>
                </form>
            </div>
