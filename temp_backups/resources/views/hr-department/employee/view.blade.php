									...
									<table id="dt-employees-regular" class="table table-bordered table-hover w-100 dataTable dtr-inline" role="grid" aria-describedby="dt-basic-example_info" style="width: 1222px;">
										<thead class="bg-warning-500 text-center">
											<tr role="row">
												...
												<th>department</th>
												<th>position</th>
												<th class="sorting" tabindex="0" aria-controls="dt-basic-example" rowspan="1" colspan="1" data-column-index="1">Department</th>
												<th>email</th>
...
<div class="modal fade" id="create-erp-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
			<form method="post" id="create-erp-form"  action="{{ route('hr-employee-functions', ['id' => 'create-erp']) }}">
                @csrf()
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<button type="submit" class="btn btn-primary" form="create-erp-form" >Submit</button>
            </div>
        </div>
    </div>
</div>
