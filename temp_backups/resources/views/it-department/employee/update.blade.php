...
<div class="row">
	...
	<div class="col-md-12">
        ...
        <div class="tab-pane fade show active" id="personal-information" role="tabpanel" aria-labelledby="Personal Info Div">
            <div class="col-lg-12">
                <div id="panel-4" class="panel">
                    <form method="post" id="personal-information-form"  action="{{ route('employee-functions', ['id' => 'update-personal-information']) }}">
                        @csrf()
        ...
        <div class="tab-pane fade show" id="background" role="tabpanel" aria-labelledby="Background Div">
            <div id="panel-4" class="panel">
                <form method="post" id="background-information-form"  action="{{ route('employee-functions', ['id' => 'update-background-information']) }}">
                    @csrf()
                    <input type="hidden" class="form-control" value="{{encryptor('encrypt',$employee->id)}}" required name="employeeId" />
                <div class="row p-5">
        ...
        <div class="tab-pane fade show" id="employee-information" role="tabpanel" aria-labelledby="Emplyoee Info Div">
            <div id="panel-4" class="panel">
                <form method="post" id="employee-information-form"  action="{{ route('employee-functions', ['id' => 'update-employee-information']) }}">
                @csrf()
                <input type="hidden" class="form-control" value="{{encryptor('encrypt',$employee->id)}}" required name="employeeId" />
                <div class="row p-5">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding-top:22px;">
        ...
        <div class="tab-pane fade show" id="picture-information" role="tabpanel" aria-labelledby="Picture Div">
            <div id="panel-4" class="panel">
                <form method="post" id="picture-information-form"  action="{{ route('employee-functions', ['id' => 'update-picture-information']) }}" enctype="multipart/form-data">
                @csrf()
                <input type="hidden" class="form-control" value="{{encryptor('encrypt',$employee->id)}}" required name="employeeId" />
                    <div class="row p-5">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
