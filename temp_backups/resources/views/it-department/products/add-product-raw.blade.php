...
@endphp
<form class="" role="form" id="create-product-raw" onsubmit="$('#btn-add-raw').attr('disabled',true)" method="POST" action="{{ route('product-functions',['id' => 'add-product-raw']) }}" enctype="multipart/form-data">
    @csrf()
    <div class="row mb-3">
        <div class="col-md-8">
