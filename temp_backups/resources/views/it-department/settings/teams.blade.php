                                    ...
                                    <tr role="row " class="odd">
                                        ...
                                        <td style="vertical-align: middle" class="pb-0">
                                            <div class="demo text-center mb-0">
                                                ...
                                                <input type="checkbox" class="trigger" onChange="updateTeamStatus('{{ $enc_team_id }}')" @if($team->status == 'ACTIVE') checked @endif>
                ...
                <form method="post" id="submit-team-form" action="{{ route('settings-functions',['id' => 'add-teams']) }}" enctype="multipart/form-data">
                    @csrf()
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required name="team-telephone" id="team-telephone">
                        </div>
                </form>
            </div>
            <div class="modal-footer pt-2">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="submit" form="submit-team-form" class="btn btn-info">Submit</button>
            </div>
        </div>
    </div>
</div>
    ...
    <script>
        ...
        $(document).ready(function(index){
            ...
            $("#select-branch").select2({ 
                ...
                allowClear: true,
                width:'100%',
                dropdownParent: $('#add-teams-modal')
            });

            $("#select-team-manager").select2({ 
            ...
            $("#select-team-manager").on("change", function() {
                var manager = $("#select-team-manager option:selected").text();
                $("#team-manager-name").val($.trim(manager));
            });
        });
    </script>
@endsection
